...
export default function Home() {
  ...
  return <main className="app-shell"><section className="phone-frame">
    ...
    <div className="content-scroll">{tab === 'menu' && <MenuView dishes={menuDishes} onSelect={setSelectedDish} />}{tab === 'test' && <TestView dishes={data.dishes.filter((dish) => !isDrink(dish.category))} user={user} selectedDishIds={testDishIds} onClearSelection={() => setTestDishIds([])} />}{tab === 'book' && <BookView />}{tab === 'admin' && <AdminView data={data} refresh={refresh} />}</div>
